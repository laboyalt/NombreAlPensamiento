//
//  ProfileViewBenjamin.swift
//  NombreAlPensamientoDolby
//
//  Created by Angelik Laboy on 11/06/2022.
//
//  Profile & Background card for Candidate 2

import SwiftUI

struct ProfileViewBenjamin: View {
    @State var show = false
    var body: some View {
        ZStack{
            VStack{
                //Background Card with Benjamin's information along with the exit button
                ...
                Image("DorimarBackground")
                    .offset(x: show ? -5: 0, y:17) //For design purposes, the card is a bit twist to make it visable for the user
            ...
            ZStack{
                ...
                Image("DorimarProfile") 
                    //Building the Card's shape
                    .frame(width:307,height:410)
                    .shadow(color: .gray, radius: 5, x:0, y:5)
                    .cornerRadius(24)
                VStack{
                    //Profile Card containing Benjamin's name and information
