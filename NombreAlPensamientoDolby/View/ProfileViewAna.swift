//
//  ProfileViewAna.swift
//  NombreAlPensamientoDolby
//
//  Created by Angelik Laboy on 11/06/2022.
//
//  Profile & Background card for Candidate 3

import SwiftUI

struct ProfileViewAna: View {
    @State var show = false
    var body: some View {
        ZStack{
            //Background Card with Ana's information along with the exit button
            ...
            VStack{
                Image("AnaBackground")
                    .offset(x: show ? -5: 0, y:12) //For design purposes, the card is a bit twist to make it visable for the user
            ...
            ZStack{
                ...
                Image("AnaProfile") 
                    ...
                    .cornerRadius(24)
                VStack{
                    //Profile Card containing Ana's name and information icon
